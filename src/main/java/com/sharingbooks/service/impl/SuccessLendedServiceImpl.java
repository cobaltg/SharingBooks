...
public class SuccessLendedServiceImpl implements SuccessLendedService {
	...
	public List<SuccessLended> getSuccessLendedListOfUserByPage(
		...
		// 获取需要显示书籍信息总条数
		page.setTotalNumber(successLendedDao
				.countSuccessLendedOfUser(userPhone));
		// 根据偏移量显示分页书籍信息
		System.out.println("++++++++++++++++++++++++++++++");
		System.out.println(page);
		System.out.println("++++++++++++++++++++++++++++++");
		return successLendedDao.querySuccessLendedListOfUserByPage(userPhone,
				page.getDbIndex(), page.getDbNumber());
	}
